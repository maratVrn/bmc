...
const AllStrategy = () => {
    ...
    <div className='container ' style={{marginTop:'130px', marginBottom:'70px'}} >
        <h1>Инвестиционные торговые стратегии</h1>
        <p style={{marginTop:'40px', marginBottom:'40px'}}> Ниже представлены результаты торговых стратегий для акций
            рынка РФ а также торговых портфелей. Вы можете просмотреть детальную информацию  – сделки, риски, активные сделки - для этого нажмите по выбранной стратегии или портфелю</p>
